...
class UserPreferenceRowsData extends DataClass
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'backgroundMusicEnabled': serializer.toJson<int>(backgroundMusicEnabled),
...
class JourneyAssetRows extends Table
    with TableInfo<JourneyAssetRows, JourneyAssetRowsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  JourneyAssetRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> ownerId = GeneratedColumn<String>(
    'owner_id',
    aliasedName,
    false,
  ...
  @override
  JourneyAssetRowsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return JourneyAssetRowsData(
      ownerId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}owner_id'],
      )!,
  ...
  @override
  JourneyAssetRows createAlias(String alias) {
    return JourneyAssetRows(attachedDatabase, alias);
  }
...
class JourneyAssetRowsData extends DataClass
    implements Insertable<JourneyAssetRowsData> {
  final String ownerId;
  final String journeyId;
  final int assetsVersion;
  final String downloadedAt;
  const JourneyAssetRowsData({
    required this.ownerId,
    required this.journeyId,
  ...
  factory JourneyAssetRowsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  JourneyAssetRowsData copyWith({
    String? ownerId,
    String? journeyId,
    int? assetsVersion,
    String? downloadedAt,
  }) => JourneyAssetRowsData(
    ownerId: ownerId ?? this.ownerId,
    journeyId: journeyId ?? this.journeyId,
    assetsVersion: assetsVersion ?? this.assetsVersion,
    downloadedAt: downloadedAt ?? this.downloadedAt,
  );
  JourneyAssetRowsData copyWithCompanion(JourneyAssetRowsCompanion data) {
    return JourneyAssetRowsData(
      ownerId: data.ownerId.present ? data.ownerId.value : this.ownerId,
      journeyId: data.journeyId.present ? data.journeyId.value : this.journeyId,
  ...
  @override
  String toString() {
    return (StringBuffer('JourneyAssetRowsData(')
          ..write('ownerId: $ownerId, ')
          ..write('journeyId: $journeyId, ')
...
class JourneyAssetRowsCompanion extends UpdateCompanion<JourneyAssetRowsData> {
  final Value<String> ownerId;
  final Value<String> journeyId;
  ...
  JourneyAssetRowsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       assetsVersion = Value(assetsVersion),
       downloadedAt = Value(downloadedAt);
  static Insertable<JourneyAssetRowsData> custom({
    Expression<String>? ownerId,
    Expression<String>? journeyId,
...
class DatabaseAtV5 extends GeneratedDatabase {
  ...
  late final JourneyAssetRows journeyAssetRows = JourneyAssetRows(this);
  @override
