...
/// same way. Trophies (§6.3's achievements) live only on the Трофеи tab,
/// not here — this screen shows the route, its landmarks, and the
/// traveler's own position, nothing else. Tapping the traveler or a
/// landmark shows a small tooltip with its stats (§6.2's "interactive
/// hotspots"); tapping empty space, or the same marker again, dismisses
/// it. Pan and zoom come from [InteractiveViewer]; nothing here touches
